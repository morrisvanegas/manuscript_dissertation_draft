...
\makeindex
\usepackage{makeidx}
\usepackage{acronym} %[nohyperlinks]{acronym}  % see https://tex.stackexchange.com/questions/25520/how-can-i-use-the-latex-acronym-package-and-optionally-create-an-acronym-list-i
