...
\begin{figure}
\begin{center}
\subfigure[]{\label{fg:stag1}\includegraphics[height=4.5cm]{fig/moca/Fig_10a.pdf}}
\subfigure[]{\label{fg:stag2}\includegraphics[height=4.5cm]{fig/moca/Fig_10b.pdf}}
\subfigure[]{\label{fg:stag4}\includegraphics[height=4.5cm]{fig/moca/Fig_10c.pdf}}
\subfigure[]{\label{fg:stag5}\includegraphics[height=4.5cm]{fig/moca/Fig_10d.pdf}}
\subfigure[]{\label{fg:stag3}\includegraphics[height=4.5cm]{fig/moca/Fig_10e.pdf}}
\subfigure[]{\label{fg:stag6}\includegraphics[height=4.5cm]{fig/moca/Fig_10f.pdf}}
\end{center}
